...
import ButtonStep from "./../ButtonComponent/ButtonStep"
  ...
  return (
    <section>
      ...
      {showCardForm.map((show, index) => (
        show && <CardForm key={index} numberCard={index} active={index === currentStep} onNext={() => handleNextClick(index)} onPrev={() => handlePrevClick(index)} />
      ))}
